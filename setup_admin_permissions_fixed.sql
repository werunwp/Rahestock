-- Admin Permissions Setup Script (FIXED)
...
-- FIXED: Only uses valid user_role enum values: 'admin', 'manager', 'staff'
...
-- Insert default role permissions for all roles (FIXED: Only admin, manager, staff)
...
SELECT 'All role-based permissions are configured (admin, manager, staff only).' as note2;
