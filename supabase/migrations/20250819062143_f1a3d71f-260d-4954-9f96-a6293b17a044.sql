...
-- Drop the security definer view first
DROP VIEW IF EXISTS public.woocommerce_connections_secure CASCADE;
...
DROP FUNCTION IF EXISTS public.upsert_woocommerce_connection CASCADE;

-- Recreate encrypt function with proper security settings
...
-- Recreate decrypt function with proper security settings
...
-- Recreate upsert function with proper security settings
...
-- Create a function for secure access instead of a view
