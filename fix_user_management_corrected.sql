-- Fix User Management by dropping and recreating the RPC function
-- Run this in Supabase SQL Editor: https://supabase.rahedeen.com/project/default/sql/new?skip=true
